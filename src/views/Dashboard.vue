<template>
  ...
  <AdminDashboard v-if="isAdminVisible" @update:isAdminVisible="isAdminVisible = $event" />
  <div class="flex justify-center items-center h-full w-full md:block"><Calendar /></div>
</template>
